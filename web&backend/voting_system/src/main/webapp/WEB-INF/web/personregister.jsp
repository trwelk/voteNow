                                            ...
                                            <div class="form-row">
                                              ...
                                              <div class="col-md-4 mb-3">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                  ...
                                                  <input type="number" class="form-control" id="mobile1" placeholder="Mobile one" required="">
                                                  <div class="invalid-feedback">
                                              ...
                                              <div class="col-md-4 mb-3">
                                                   ...
                                                   <input type="number" class="form-control" id="mobile2" placeholder="Mobile two" required="">
                                                   <div class="invalid-feedback">
...
/*  function phonenumber(inputtxt)
  {
    ...
    if(inputtxt.value.match(phoneno))
          ...
          {
          alert("You can not enter 10 number more");
